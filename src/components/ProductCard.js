...
const ProductCard = ({ product }) => {
  ...
  return (
    ...
    >
      {
        pathname.includes("cart") &&  <div className="grid place-items-center bg-indigo-500 absolute top-2 right-2 text-white h-8 w-8 rounded-full">
      ...
      <div className='flex gap-2 mt-5'>
        ...
        {
          pathname.includes("cart") && <button onClick={() => dispatch(removeFromCart(product))} className='bg-red-500 flex justify-between items-center rounded-full py-1 px-3 flex-1 text-white text-bold'>
